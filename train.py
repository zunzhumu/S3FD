...
def parse_args():
    ...
    parser.add_argument('--frequent', dest='frequent', help='frequency of logging',
                        default=20, type=int)
    parser.add_argument('--data-shape', dest='data_shape', type=int, default=608,
                        help='set image shape')
    parser.add_argument('--label-width', dest='label_width', type=int, default=11774,
    ...
    parser.add_argument('--log', dest='log_file', type=str, default="train_vgg16_608_widerface_s3fd.log",
    ...
    parser.add_argument('--num-example', dest='num_example', type=int, default=12280,
    ...
    parser.add_argument('--overlap', dest='overlap_thresh', type=float, default=0.35,
