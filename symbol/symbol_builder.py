...
def get_symbol_train(network, num_classes, from_layers, num_filters, strides, pads,
    ...
    tmp = mx.symbol.contrib.MultiBoxTarget(
        *[anchor_boxes, label, cls_preds], overlap_threshold=.35, \
        ignore_label=-1, negative_mining_ratio=3, minimum_negative_samples=0, \
        negative_mining_thresh=.35, variances=(0.1, 0.1, 0.2, 0.2),
    ...
    cls_prob = mx.symbol.SoftmaxOutput(data=cls_preds, label=cls_target, \
        ignore_label=-1, use_ignore=True, grad_scale=4.0, multi_output=True, \
    ...
    det = mx.symbol.contrib.MultiBoxDetection(*[cls_prob, loc_preds, anchor_boxes], \
                                              ...
                                              variances=(0.1, 0.1, 0.2, 0.2), nms_topk=nms_topk, threshold=0.01)
    print 'nms_topk', nms_topk
